...
def add_task():  
    ...
    if len(task_string) == 0:  
        ...
        the_connection.commit()  # Commit after adding a task
        list_update()    
...
def delete_task():  
    try:  
        ...
        if the_value in tasks:  
            ...
            the_connection.commit()  # Commit after deleting a task
    except IndexError:   
...
def delete_all_tasks():  
    ...
    if message_box:    
        ...
        the_connection.commit()  # Commit after deleting all tasks
        list_update()  
